...
The authoritative version of record is the Zenodo DOI: [10.5281/zenodo.18513751](https://doi.org/10.5281/zenodo.18513751)
...
This analysis is based on systematic observation of AI candidate surfacing behavior across multiple platforms (Google AI, ChatGPT, Claude, Perplexity, Gemini), empirical testing through CV4Students—a non-commercial educational platform with verified AI visibility across 125+ countries—and technical understanding of how large language models evaluate competitive readiness, assess risk profiles for surfacing trusted domains, and differentiate candidate pool entry based on commercial classification.
...
*End of Stage 8 — Candidate Surfacing*
